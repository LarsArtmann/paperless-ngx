...
module.exports = {
	...
	moduleNameMapper: {
		...
		"^src/(.*)": "<rootDir>/src/$1",
		"^pdfjs-dist/legacy/build/pdf\\.mjs$": "<rootDir>/src/test/mocks/pdfjs-legacy-build-pdf.ts",
		"^pdfjs-dist/web/pdf_viewer\\.mjs$": "<rootDir>/src/test/mocks/pdfjs-web-pdf_viewer.ts",
	},
